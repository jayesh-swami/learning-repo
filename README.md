# learning-repo
Repository to store all my notes, resources, paper reviews etc. As an ambition to best keep track of my learning, each course directory contains a `course_metadata.yaml` file that serves as the single source of truth for the course's progress, context, and academic connections. The format is as follows - 
